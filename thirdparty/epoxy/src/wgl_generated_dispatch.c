...
GEN_THUNKS_RET(void *, epoxy_wglAllocateMemoryNV, (GLsizei size, GLfloat readfreq, GLfloat writefreq, GLfloat priority), (size, readfreq, writefreq, priority))
GEN_THUNKS_RET(BOOL, epoxy_wglAssociateImageBufferEventsI3D, (HDC hDC, const HANDLE * pEvent, const LPVOID * pAddress, const DWORD * pSize, UINT count), (hDC, pEvent, pAddress, pSize, count))
GEN_THUNKS_RET(BOOL, epoxy_wglBeginFrameTrackingI3D, (void), ())
GEN_THUNKS_RET(GLboolean, epoxy_wglBindDisplayColorTableEXT, (GLushort id), (id))
GEN_THUNKS_RET(BOOL, epoxy_wglBindSwapBarrierNV, (GLuint group, GLuint barrier), (group, barrier))
GEN_THUNKS_RET(BOOL, epoxy_wglBindTexImageARB, (HPBUFFERARB hPbuffer, int iBuffer), (hPbuffer, iBuffer))
GEN_THUNKS_RET(BOOL, epoxy_wglBindVideoCaptureDeviceNV, (UINT uVideoSlot, HVIDEOINPUTDEVICENV hDevice), (uVideoSlot, hDevice))
GEN_THUNKS_RET(BOOL, epoxy_wglBindVideoDeviceNV, (HDC hDC, unsigned int uVideoSlot, HVIDEOOUTPUTDEVICENV hVideoDevice, const int * piAttribList), (hDC, uVideoSlot, hVideoDevice, piAttribList))
GEN_THUNKS_RET(BOOL, epoxy_wglBindVideoImageNV, (HPVIDEODEV hVideoDevice, HPBUFFERARB hPbuffer, int iVideoBuffer), (hVideoDevice, hPbuffer, iVideoBuffer))
GEN_THUNKS(epoxy_wglBlitContextFramebufferAMD, (HGLRC dstCtx, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter), (dstCtx, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter))
GEN_THUNKS_RET(BOOL, epoxy_wglChoosePixelFormatARB, (HDC hdc, const int * piAttribIList, const FLOAT * pfAttribFList, UINT nMaxFormats, int * piFormats, UINT * nNumFormats), (hdc, piAttribIList, pfAttribFList, nMaxFormats, piFormats, nNumFormats))
GEN_THUNKS_RET(BOOL, epoxy_wglChoosePixelFormatEXT, (HDC hdc, const int * piAttribIList, const FLOAT * pfAttribFList, UINT nMaxFormats, int * piFormats, UINT * nNumFormats), (hdc, piAttribIList, pfAttribFList, nMaxFormats, piFormats, nNumFormats))
GEN_THUNKS_RET(BOOL, epoxy_wglCopyContext, (HGLRC hglrcSrc, HGLRC hglrcDst, UINT mask), (hglrcSrc, hglrcDst, mask))
GEN_THUNKS_RET(BOOL, epoxy_wglCopyImageSubDataNV, (HGLRC hSrcRC, GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, HGLRC hDstRC, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei width, GLsizei height, GLsizei depth), (hSrcRC, srcName, srcTarget, srcLevel, srcX, srcY, srcZ, hDstRC, dstName, dstTarget, dstLevel, dstX, dstY, dstZ, width, height, depth))
GEN_THUNKS_RET(HDC, epoxy_wglCreateAffinityDCNV, (const HGPUNV * phGpuList), (phGpuList))
GEN_THUNKS_RET(HGLRC, epoxy_wglCreateAssociatedContextAMD, (UINT id), (id))
GEN_THUNKS_RET(HGLRC, epoxy_wglCreateAssociatedContextAttribsAMD, (UINT id, HGLRC hShareContext, const int * attribList), (id, hShareContext, attribList))
GEN_THUNKS_RET(HANDLE, epoxy_wglCreateBufferRegionARB, (HDC hDC, int iLayerPlane, UINT uType), (hDC, iLayerPlane, uType))
GEN_THUNKS_RET(HGLRC, epoxy_wglCreateContext, (HDC hDc), (hDc))
GEN_THUNKS_RET(HGLRC, epoxy_wglCreateContextAttribsARB, (HDC hDC, HGLRC hShareContext, const int * attribList), (hDC, hShareContext, attribList))
GEN_THUNKS_RET(GLboolean, epoxy_wglCreateDisplayColorTableEXT, (GLushort id), (id))
GEN_THUNKS_RET(LPVOID, epoxy_wglCreateImageBufferI3D, (HDC hDC, DWORD dwSize, UINT uFlags), (hDC, dwSize, uFlags))
GEN_THUNKS_RET(HGLRC, epoxy_wglCreateLayerContext, (HDC hDc, int level), (hDc, level))
GEN_THUNKS_RET(HPBUFFERARB, epoxy_wglCreatePbufferARB, (HDC hDC, int iPixelFormat, int iWidth, int iHeight, const int * piAttribList), (hDC, iPixelFormat, iWidth, iHeight, piAttribList))
GEN_THUNKS_RET(HPBUFFEREXT, epoxy_wglCreatePbufferEXT, (HDC hDC, int iPixelFormat, int iWidth, int iHeight, const int * piAttribList), (hDC, iPixelFormat, iWidth, iHeight, piAttribList))
GEN_THUNKS_RET(BOOL, epoxy_wglDXCloseDeviceNV, (HANDLE hDevice), (hDevice))
GEN_THUNKS_RET(BOOL, epoxy_wglDXLockObjectsNV, (HANDLE hDevice, GLint count, HANDLE * hObjects), (hDevice, count, hObjects))
GEN_THUNKS_RET(BOOL, epoxy_wglDXObjectAccessNV, (HANDLE hObject, GLenum access), (hObject, access))
GEN_THUNKS_RET(HANDLE, epoxy_wglDXOpenDeviceNV, (void * dxDevice), (dxDevice))
GEN_THUNKS_RET(HANDLE, epoxy_wglDXRegisterObjectNV, (HANDLE hDevice, void * dxObject, GLuint name, GLenum type, GLenum access), (hDevice, dxObject, name, type, access))
GEN_THUNKS_RET(BOOL, epoxy_wglDXSetResourceShareHandleNV, (void * dxObject, HANDLE shareHandle), (dxObject, shareHandle))
GEN_THUNKS_RET(BOOL, epoxy_wglDXUnlockObjectsNV, (HANDLE hDevice, GLint count, HANDLE * hObjects), (hDevice, count, hObjects))
GEN_THUNKS_RET(BOOL, epoxy_wglDXUnregisterObjectNV, (HANDLE hDevice, HANDLE hObject), (hDevice, hObject))
GEN_THUNKS_RET(BOOL, epoxy_wglDelayBeforeSwapNV, (HDC hDC, GLfloat seconds), (hDC, seconds))
GEN_THUNKS_RET(BOOL, epoxy_wglDeleteAssociatedContextAMD, (HGLRC hglrc), (hglrc))
GEN_THUNKS(epoxy_wglDeleteBufferRegionARB, (HANDLE hRegion), (hRegion))
GEN_THUNKS_RET(BOOL, epoxy_wglDeleteContext, (HGLRC oldContext), (oldContext))
GEN_THUNKS_RET(BOOL, epoxy_wglDeleteDCNV, (HDC hdc), (hdc))
GEN_THUNKS_RET(BOOL, epoxy_wglDescribeLayerPlane, (HDC hDc, int pixelFormat, int layerPlane, UINT nBytes, const LAYERPLANEDESCRIPTOR * plpd), (hDc, pixelFormat, layerPlane, nBytes, plpd))
GEN_THUNKS(epoxy_wglDestroyDisplayColorTableEXT, (GLushort id), (id))
GEN_THUNKS_RET(BOOL, epoxy_wglDestroyImageBufferI3D, (HDC hDC, LPVOID pAddress), (hDC, pAddress))
GEN_THUNKS_RET(BOOL, epoxy_wglDestroyPbufferARB, (HPBUFFERARB hPbuffer), (hPbuffer))
GEN_THUNKS_RET(BOOL, epoxy_wglDestroyPbufferEXT, (HPBUFFEREXT hPbuffer), (hPbuffer))
GEN_THUNKS_RET(BOOL, epoxy_wglDisableFrameLockI3D, (void), ())
GEN_THUNKS_RET(BOOL, epoxy_wglDisableGenlockI3D, (HDC hDC), (hDC))
GEN_THUNKS_RET(BOOL, epoxy_wglEnableFrameLockI3D, (void), ())
GEN_THUNKS_RET(BOOL, epoxy_wglEnableGenlockI3D, (HDC hDC), (hDC))
GEN_THUNKS_RET(BOOL, epoxy_wglEndFrameTrackingI3D, (void), ())
GEN_THUNKS_RET(BOOL, epoxy_wglEnumGpuDevicesNV, (HGPUNV hGpu, UINT iDeviceIndex, PGPU_DEVICE lpGpuDevice), (hGpu, iDeviceIndex, lpGpuDevice))
GEN_THUNKS_RET(BOOL, epoxy_wglEnumGpusFromAffinityDCNV, (HDC hAffinityDC, UINT iGpuIndex, HGPUNV * hGpu), (hAffinityDC, iGpuIndex, hGpu))
GEN_THUNKS_RET(BOOL, epoxy_wglEnumGpusNV, (UINT iGpuIndex, HGPUNV * phGpu), (iGpuIndex, phGpu))
GEN_THUNKS_RET(UINT, epoxy_wglEnumerateVideoCaptureDevicesNV, (HDC hDc, HVIDEOINPUTDEVICENV * phDeviceList), (hDc, phDeviceList))
GEN_THUNKS_RET(int, epoxy_wglEnumerateVideoDevicesNV, (HDC hDC, HVIDEOOUTPUTDEVICENV * phDeviceList), (hDC, phDeviceList))
GEN_THUNKS(epoxy_wglFreeMemoryNV, (void * pointer), (pointer))
GEN_THUNKS_RET(BOOL, epoxy_wglGenlockSampleRateI3D, (HDC hDC, UINT uRate), (hDC, uRate))
GEN_THUNKS_RET(BOOL, epoxy_wglGenlockSourceDelayI3D, (HDC hDC, UINT uDelay), (hDC, uDelay))
GEN_THUNKS_RET(BOOL, epoxy_wglGenlockSourceEdgeI3D, (HDC hDC, UINT uEdge), (hDC, uEdge))
GEN_THUNKS_RET(BOOL, epoxy_wglGenlockSourceI3D, (HDC hDC, UINT uSource), (hDC, uSource))
GEN_THUNKS_RET(UINT, epoxy_wglGetContextGPUIDAMD, (HGLRC hglrc), (hglrc))
GEN_THUNKS_RET(HGLRC, epoxy_wglGetCurrentAssociatedContextAMD, (void), ())
GEN_THUNKS_RET(HGLRC, epoxy_wglGetCurrentContext, (void), ())
GEN_THUNKS_RET(HDC, epoxy_wglGetCurrentDC, (void), ())
GEN_THUNKS_RET(HDC, epoxy_wglGetCurrentReadDCARB, (void), ())
GEN_THUNKS_RET(HDC, epoxy_wglGetCurrentReadDCEXT, (void), ())
GEN_THUNKS_RET(PROC, epoxy_wglGetDefaultProcAddress, (LPCSTR lpszProc), (lpszProc))
GEN_THUNKS_RET(BOOL, epoxy_wglGetDigitalVideoParametersI3D, (HDC hDC, int iAttribute, int * piValue), (hDC, iAttribute, piValue))
GEN_THUNKS_RET(const char *, epoxy_wglGetExtensionsStringARB, (HDC hdc), (hdc))
GEN_THUNKS_RET(const char *, epoxy_wglGetExtensionsStringEXT, (void), ())
GEN_THUNKS_RET(BOOL, epoxy_wglGetFrameUsageI3D, (float * pUsage), (pUsage))
GEN_THUNKS_RET(UINT, epoxy_wglGetGPUIDsAMD, (UINT maxCount, UINT * ids), (maxCount, ids))
GEN_THUNKS_RET(INT, epoxy_wglGetGPUInfoAMD, (UINT id, int property, GLenum dataType, UINT size, void * data), (id, property, dataType, size, data))
GEN_THUNKS_RET(BOOL, epoxy_wglGetGammaTableI3D, (HDC hDC, int iEntries, USHORT * puRed, USHORT * puGreen, USHORT * puBlue), (hDC, iEntries, puRed, puGreen, puBlue))
GEN_THUNKS_RET(BOOL, epoxy_wglGetGammaTableParametersI3D, (HDC hDC, int iAttribute, int * piValue), (hDC, iAttribute, piValue))
GEN_THUNKS_RET(BOOL, epoxy_wglGetGenlockSampleRateI3D, (HDC hDC, UINT * uRate), (hDC, uRate))
GEN_THUNKS_RET(BOOL, epoxy_wglGetGenlockSourceDelayI3D, (HDC hDC, UINT * uDelay), (hDC, uDelay))
GEN_THUNKS_RET(BOOL, epoxy_wglGetGenlockSourceEdgeI3D, (HDC hDC, UINT * uEdge), (hDC, uEdge))
GEN_THUNKS_RET(BOOL, epoxy_wglGetGenlockSourceI3D, (HDC hDC, UINT * uSource), (hDC, uSource))
GEN_THUNKS_RET(int, epoxy_wglGetLayerPaletteEntries, (HDC hdc, int iLayerPlane, int iStart, int cEntries, const COLORREF * pcr), (hdc, iLayerPlane, iStart, cEntries, pcr))
GEN_THUNKS_RET(BOOL, epoxy_wglGetMscRateOML, (HDC hdc, INT32 * numerator, INT32 * denominator), (hdc, numerator, denominator))
GEN_THUNKS_RET(HDC, epoxy_wglGetPbufferDCARB, (HPBUFFERARB hPbuffer), (hPbuffer))
GEN_THUNKS_RET(HDC, epoxy_wglGetPbufferDCEXT, (HPBUFFEREXT hPbuffer), (hPbuffer))
GEN_THUNKS_RET(BOOL, epoxy_wglGetPixelFormatAttribfvARB, (HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes, const int * piAttributes, FLOAT * pfValues), (hdc, iPixelFormat, iLayerPlane, nAttributes, piAttributes, pfValues))
GEN_THUNKS_RET(BOOL, epoxy_wglGetPixelFormatAttribfvEXT, (HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes, int * piAttributes, FLOAT * pfValues), (hdc, iPixelFormat, iLayerPlane, nAttributes, piAttributes, pfValues))
GEN_THUNKS_RET(BOOL, epoxy_wglGetPixelFormatAttribivARB, (HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes, const int * piAttributes, int * piValues), (hdc, iPixelFormat, iLayerPlane, nAttributes, piAttributes, piValues))
GEN_THUNKS_RET(BOOL, epoxy_wglGetPixelFormatAttribivEXT, (HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes, int * piAttributes, int * piValues), (hdc, iPixelFormat, iLayerPlane, nAttributes, piAttributes, piValues))
GEN_THUNKS_RET(PROC, epoxy_wglGetProcAddress, (LPCSTR lpszProc), (lpszProc))
GEN_THUNKS_RET(int, epoxy_wglGetSwapIntervalEXT, (void), ())
GEN_THUNKS_RET(BOOL, epoxy_wglGetSyncValuesOML, (HDC hdc, INT64 * ust, INT64 * msc, INT64 * sbc), (hdc, ust, msc, sbc))
GEN_THUNKS_RET(BOOL, epoxy_wglGetVideoDeviceNV, (HDC hDC, int numDevices, HPVIDEODEV * hVideoDevice), (hDC, numDevices, hVideoDevice))
GEN_THUNKS_RET(BOOL, epoxy_wglGetVideoInfoNV, (HPVIDEODEV hpVideoDevice, unsigned long * pulCounterOutputPbuffer, unsigned long * pulCounterOutputVideo), (hpVideoDevice, pulCounterOutputPbuffer, pulCounterOutputVideo))
GEN_THUNKS_RET(BOOL, epoxy_wglIsEnabledFrameLockI3D, (BOOL * pFlag), (pFlag))
GEN_THUNKS_RET(BOOL, epoxy_wglIsEnabledGenlockI3D, (HDC hDC, BOOL * pFlag), (hDC, pFlag))
GEN_THUNKS_RET(BOOL, epoxy_wglJoinSwapGroupNV, (HDC hDC, GLuint group), (hDC, group))
GEN_THUNKS_RET(GLboolean, epoxy_wglLoadDisplayColorTableEXT, (const GLushort * table, GLuint length), (table, length))
GEN_THUNKS_RET(BOOL, epoxy_wglLockVideoCaptureDeviceNV, (HDC hDc, HVIDEOINPUTDEVICENV hDevice), (hDc, hDevice))
GEN_THUNKS_RET(BOOL, epoxy_wglMakeAssociatedContextCurrentAMD_unwrapped, (HGLRC hglrc), (hglrc))
GEN_THUNKS_RET(BOOL, epoxy_wglMakeContextCurrentARB_unwrapped, (HDC hDrawDC, HDC hReadDC, HGLRC hglrc), (hDrawDC, hReadDC, hglrc))
GEN_THUNKS_RET(BOOL, epoxy_wglMakeContextCurrentEXT_unwrapped, (HDC hDrawDC, HDC hReadDC, HGLRC hglrc), (hDrawDC, hReadDC, hglrc))
GEN_THUNKS_RET(BOOL, epoxy_wglMakeCurrent_unwrapped, (HDC hDc, HGLRC newContext), (hDc, newContext))
GEN_THUNKS_RET(BOOL, epoxy_wglQueryCurrentContextNV, (int iAttribute, int * piValue), (iAttribute, piValue))
GEN_THUNKS_RET(BOOL, epoxy_wglQueryFrameCountNV, (HDC hDC, GLuint * count), (hDC, count))
GEN_THUNKS_RET(BOOL, epoxy_wglQueryFrameLockMasterI3D, (BOOL * pFlag), (pFlag))
GEN_THUNKS_RET(BOOL, epoxy_wglQueryFrameTrackingI3D, (DWORD * pFrameCount, DWORD * pMissedFrames, float * pLastMissedUsage), (pFrameCount, pMissedFrames, pLastMissedUsage))
GEN_THUNKS_RET(BOOL, epoxy_wglQueryGenlockMaxSourceDelayI3D, (HDC hDC, UINT * uMaxLineDelay, UINT * uMaxPixelDelay), (hDC, uMaxLineDelay, uMaxPixelDelay))
GEN_THUNKS_RET(BOOL, epoxy_wglQueryMaxSwapGroupsNV, (HDC hDC, GLuint * maxGroups, GLuint * maxBarriers), (hDC, maxGroups, maxBarriers))
GEN_THUNKS_RET(BOOL, epoxy_wglQueryPbufferARB, (HPBUFFERARB hPbuffer, int iAttribute, int * piValue), (hPbuffer, iAttribute, piValue))
GEN_THUNKS_RET(BOOL, epoxy_wglQueryPbufferEXT, (HPBUFFEREXT hPbuffer, int iAttribute, int * piValue), (hPbuffer, iAttribute, piValue))
GEN_THUNKS_RET(BOOL, epoxy_wglQuerySwapGroupNV, (HDC hDC, GLuint * group, GLuint * barrier), (hDC, group, barrier))
GEN_THUNKS_RET(BOOL, epoxy_wglQueryVideoCaptureDeviceNV, (HDC hDc, HVIDEOINPUTDEVICENV hDevice, int iAttribute, int * piValue), (hDc, hDevice, iAttribute, piValue))
GEN_THUNKS_RET(BOOL, epoxy_wglRealizeLayerPalette, (HDC hdc, int iLayerPlane, BOOL bRealize), (hdc, iLayerPlane, bRealize))
GEN_THUNKS_RET(BOOL, epoxy_wglReleaseImageBufferEventsI3D, (HDC hDC, const LPVOID * pAddress, UINT count), (hDC, pAddress, count))
GEN_THUNKS_RET(int, epoxy_wglReleasePbufferDCARB, (HPBUFFERARB hPbuffer, HDC hDC), (hPbuffer, hDC))
GEN_THUNKS_RET(int, epoxy_wglReleasePbufferDCEXT, (HPBUFFEREXT hPbuffer, HDC hDC), (hPbuffer, hDC))
GEN_THUNKS_RET(BOOL, epoxy_wglReleaseTexImageARB, (HPBUFFERARB hPbuffer, int iBuffer), (hPbuffer, iBuffer))
GEN_THUNKS_RET(BOOL, epoxy_wglReleaseVideoCaptureDeviceNV, (HDC hDc, HVIDEOINPUTDEVICENV hDevice), (hDc, hDevice))
GEN_THUNKS_RET(BOOL, epoxy_wglReleaseVideoDeviceNV, (HPVIDEODEV hVideoDevice), (hVideoDevice))
GEN_THUNKS_RET(BOOL, epoxy_wglReleaseVideoImageNV, (HPBUFFERARB hPbuffer, int iVideoBuffer), (hPbuffer, iVideoBuffer))
GEN_THUNKS_RET(BOOL, epoxy_wglResetFrameCountNV, (HDC hDC), (hDC))
GEN_THUNKS_RET(BOOL, epoxy_wglRestoreBufferRegionARB, (HANDLE hRegion, int x, int y, int width, int height, int xSrc, int ySrc), (hRegion, x, y, width, height, xSrc, ySrc))
GEN_THUNKS_RET(BOOL, epoxy_wglSaveBufferRegionARB, (HANDLE hRegion, int x, int y, int width, int height), (hRegion, x, y, width, height))
GEN_THUNKS_RET(BOOL, epoxy_wglSendPbufferToVideoNV, (HPBUFFERARB hPbuffer, int iBufferType, unsigned long * pulCounterPbuffer, BOOL bBlock), (hPbuffer, iBufferType, pulCounterPbuffer, bBlock))
GEN_THUNKS_RET(BOOL, epoxy_wglSetDigitalVideoParametersI3D, (HDC hDC, int iAttribute, const int * piValue), (hDC, iAttribute, piValue))
GEN_THUNKS_RET(BOOL, epoxy_wglSetGammaTableI3D, (HDC hDC, int iEntries, const USHORT * puRed, const USHORT * puGreen, const USHORT * puBlue), (hDC, iEntries, puRed, puGreen, puBlue))
GEN_THUNKS_RET(BOOL, epoxy_wglSetGammaTableParametersI3D, (HDC hDC, int iAttribute, const int * piValue), (hDC, iAttribute, piValue))
GEN_THUNKS_RET(int, epoxy_wglSetLayerPaletteEntries, (HDC hdc, int iLayerPlane, int iStart, int cEntries, const COLORREF * pcr), (hdc, iLayerPlane, iStart, cEntries, pcr))
GEN_THUNKS_RET(BOOL, epoxy_wglSetPbufferAttribARB, (HPBUFFERARB hPbuffer, const int * piAttribList), (hPbuffer, piAttribList))
GEN_THUNKS_RET(BOOL, epoxy_wglSetStereoEmitterState3DL, (HDC hDC, UINT uState), (hDC, uState))
GEN_THUNKS_RET(BOOL, epoxy_wglShareLists, (HGLRC hrcSrvShare, HGLRC hrcSrvSource), (hrcSrvShare, hrcSrvSource))
GEN_THUNKS_RET(INT64, epoxy_wglSwapBuffersMscOML, (HDC hdc, INT64 target_msc, INT64 divisor, INT64 remainder), (hdc, target_msc, divisor, remainder))
GEN_THUNKS_RET(BOOL, epoxy_wglSwapIntervalEXT, (int interval), (interval))
GEN_THUNKS_RET(BOOL, epoxy_wglSwapLayerBuffers, (HDC hdc, UINT fuFlags), (hdc, fuFlags))
GEN_THUNKS_RET(INT64, epoxy_wglSwapLayerBuffersMscOML, (HDC hdc, int fuPlanes, INT64 target_msc, INT64 divisor, INT64 remainder), (hdc, fuPlanes, target_msc, divisor, remainder))
GEN_THUNKS_RET(BOOL, epoxy_wglUseFontBitmapsA, (HDC hDC, DWORD first, DWORD count, DWORD listBase), (hDC, first, count, listBase))
GEN_THUNKS_RET(BOOL, epoxy_wglUseFontBitmapsW, (HDC hDC, DWORD first, DWORD count, DWORD listBase), (hDC, first, count, listBase))
GEN_THUNKS_RET(BOOL, epoxy_wglUseFontOutlines, (HDC hDC, DWORD first, DWORD count, DWORD listBase, FLOAT deviation, FLOAT extrusion, int format, LPGLYPHMETRICSFLOAT lpgmf), (hDC, first, count, listBase, deviation, extrusion, format, lpgmf))
GEN_THUNKS_RET(BOOL, epoxy_wglUseFontOutlinesA, (HDC hDC, DWORD first, DWORD count, DWORD listBase, FLOAT deviation, FLOAT extrusion, int format, LPGLYPHMETRICSFLOAT lpgmf), (hDC, first, count, listBase, deviation, extrusion, format, lpgmf))
GEN_THUNKS_RET(BOOL, epoxy_wglUseFontOutlinesW, (HDC hDC, DWORD first, DWORD count, DWORD listBase, FLOAT deviation, FLOAT extrusion, int format, LPGLYPHMETRICSFLOAT lpgmf), (hDC, first, count, listBase, deviation, extrusion, format, lpgmf))
GEN_THUNKS_RET(BOOL, epoxy_wglWaitForMscOML, (HDC hdc, INT64 target_msc, INT64 divisor, INT64 remainder, INT64 * ust, INT64 * msc, INT64 * sbc), (hdc, target_msc, divisor, remainder, ust, msc, sbc))
GEN_THUNKS_RET(BOOL, epoxy_wglWaitForSbcOML, (HDC hdc, INT64 target_sbc, INT64 * ust, INT64 * msc, INT64 * sbc), (hdc, target_sbc, ust, msc, sbc))
